...
from .views import (
    register, login_view, create_post, home, success, update_post, delete_post,
    hello_user, my_posts_view, like_post, notifications, logout_view, add_comment,
    update_comment, delete_comment, all_posts_view, like_post_view, comment_post_view
)
